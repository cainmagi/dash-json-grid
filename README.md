...
### Write your component code in `src/lib/components/DashJsonGrid.react.js`.
...
- Add custom styles to your component by putting your custom CSS files into your distribution folder (`dash_json_grid`).
...
3. Test your tarball by copying it into a new environment and installing it locally:
    ```
    $ pip install dash_json_grid-0.0.1.tar.gz
    ```
