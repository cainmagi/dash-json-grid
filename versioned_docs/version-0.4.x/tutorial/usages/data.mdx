...
description: A guide overviewing the supported data rendering methods of DashJsonGrid.
slug: /usages/data
---
...
[`Sequence`<IconExternalLink/>][link-sequence] or a
[`Mapping`<IconExternalLink/>][link-mapping] will be automatically converted to
...
A sequence containing literal or unstructured values will be rendered as a vertical
list containing an index column and a value column.
