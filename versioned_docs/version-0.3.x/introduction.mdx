...
Dash JSON Grid is a [Dash component<IconExternalLink/>][link-dash-component] library.
...
you are viewing because it is built with <AppVer/> which may not match the
...
- [RedHeadphone/react-json-grid<IconExternalLink/>][git-react-json-grid]:
  The original React component implementation of this project.
