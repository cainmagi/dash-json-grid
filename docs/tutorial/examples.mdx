...
import {sourceURL} from "@site/src/envs/variables";
...
<p>
  <DarkButton to={sourceURL("usage.py")} icon={mdiLanguagePython}>
    {"usage.py"}
  </DarkButton>
</p>
...
The other features are already mentioned in the [usage guides](/category/usages).
